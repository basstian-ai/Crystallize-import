// src/item/index.ts
import {
  CreateDocumentInputSchema as CreateDocumentInputSchema2,
  CreateFolderInputSchema as CreateFolderInputSchema2,
  CreateProductInputSchema as CreateProductInputSchema2,
  UpdateDocumentInputSchema as UpdateDocumentInputSchema2,
  UpdateFolderInputSchema as UpdateFolderInputSchema2,
  UpdateProductInputSchema as UpdateProductInputSchema2
} from "@crystallize/schema";

// src/item/mutations/createDocument.ts
import { CreateDocumentInputSchema } from "@crystallize/schema";
var query = `
...
import { CreateFolderInputSchema } from "@crystallize/schema";
var query2 = `
...
import { CreateProductInputSchema } from "@crystallize/schema";
var query3 = `
...
import { UpdateDocumentInputSchema } from "@crystallize/schema";
var query4 = `
...
import { UpdateFolderInputSchema } from "@crystallize/schema";
var query5 = `
...
import { UpdateProductInputSchema } from "@crystallize/schema";
var query6 = `
      ...
      switch (data.type) {
        case "product":
          return updateProductMutation({
            id: data.id,
            language: data.language,
            input: UpdateProductInputSchema2.parse(data)
          });
        case "document":
          return updateDocumentMutation({
            id: data.id,
            language: data.language,
            input: UpdateDocumentInputSchema2.parse(data)
          });
        case "folder":
          return updateFolderMutation({
            id: data.id,
            language: data.language,
            input: UpdateFolderInputSchema2.parse(data)
          });
      }
    }
    const createInput = {
    ...
    switch (data.type) {
      case "product":
        return createProductMutation({
          language: data.language,
          input: CreateProductInputSchema2.parse(createInput)
        });
      case "document":
        return createDocumentMutation({
          language: data.language,
          input: CreateDocumentInputSchema2.parse(createInput)
        });
      case "folder":
        return createFolderMutation({
          language: data.language,
          input: CreateFolderInputSchema2.parse(createInput)
        });
    }
  };
...
// src/shape/index.ts
import {
  CreateShapeInputSchema as CreateShapeInputSchema2,
  UpdateShapeInputSchema as UpdateShapeInputSchema2
} from "@crystallize/schema";

// src/shape/mutations/create.ts
import { CreateShapeInputSchema } from "@crystallize/schema";
var query8 = `
...
import { UpdateShapeInputSchema } from "@crystallize/schema";
var query9 = `
  ...
  const determineMutation = async (client) => {
    ...
    if (await exists(client)) {
      return updateShapeMutation({
        tenantId,
        identifier: data.identifier,
        input: UpdateShapeInputSchema2.parse({
          ...data,
    ...
    return createShapeMutation({
      input: CreateShapeInputSchema2.parse({
        ...data,
        components: data.components?.map(shapeComponentToInput),
        variantComponents: data.variantComponents?.map(shapeComponentToInput),
        tenantId
...
// src/tenant/index.ts
import { CreateTenantInputSchema as CreateTenantInputSchema2 } from "@crystallize/schema";

// src/tenant/mutations/create.ts
import { CreateTenantInputSchema } from "@crystallize/schema";
var query12 = `
...
var tenant = (data) => {
  ...
  const determineMutation = async (client) => {
    return createTenantMutation({
      input: CreateTenantInputSchema2.parse(data)
    });
  };
  const execute = async (client) => {
    const { query: query18, variables, type } = await determineMutation(client);
...
// src/topic/index.ts
import { CreateTopicInputSchema as CreateTopicInputSchema2, UpdateTopicInputSchema as UpdateTopicInputSchema2, MAX_CHILD_COUNT } from "@crystallize/schema";

// src/topic/mutations/create.ts
import { CreateTopicInputSchema } from "@crystallize/schema";
var query14 = `
...
import { UpdateTopicInputSchema } from "@crystallize/schema";
var query15 = `
...
import { BulkCreateTopicInputSchema } from "@crystallize/schema";
var query17 = `
  ...
  const execute = async (client) => {
    ...
    if (await exists(client)) {
      const { query: query19, variables: variables2 } = updateTopicMutation({
        ...
        input: UpdateTopicInputSchema2.parse(data)
      });
    ...
    if (!data.children?.length || countChildren(data.children) < MAX_CHILD_COUNT) {
      const { query: query19, variables: variables2 } = createTopicMutation({
        language: data.language || "en",
        input: CreateTopicInputSchema2.parse({
          ...data,
          tenantId
        })
      });
