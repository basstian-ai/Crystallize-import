...
export type ComponentConfig = ComponentChoiceComponentConfig | ContentChunkComponentConfig | FilesComponentConfig | ItemRelationsComponentConfig | NumericComponentConfig | PropertiesTableComponentConfig | SelectionComponentConfig;
...
export declare enum ImageSortField {
    CreatedAt = "createdAt"
}
...
export declare enum ItemSortField {
    CreatedAt = "createdAt"
}
...
export declare enum PriceListModifierType {
    Absolute = "ABSOLUTE",
...
export declare enum PriceListProductSelectionType {
    AllSkus = "ALL_SKUS",
    SomeSkus = "SOME_SKUS"
}
...
export declare enum PriceListTargetAudienceType {
    Everyone = "EVERYONE",
    Some = "SOME"
}
...
export declare enum TenantCopyExcludeableTypes {
    Assets = "assets"
}
...
export type ResolversUnionTypes = {
    ComponentConfig: ComponentChoiceComponentConfig | ContentChunkComponentConfig | FilesComponentConfig | ItemRelationsComponentConfig | NumericComponentConfig | PropertiesTableComponentConfig | SelectionComponentConfig;
    ComponentContent: BooleanContent | ComponentChoiceContent | ContentChunkContent | DatetimeContent | FileContent | GridRelationsContent | ImageContent | ItemRelationsContent | LocationContent | NumericContent | ParagraphCollectionContent | PropertiesTableContent | RichTextContent | SelectionContent | SingleLineContent | VideoContent;
    Payment: CashPayment | CustomPayment | KlarnaPayment | PaypalPayment | StripePayment;
};
...
export type ResolversTypes = {
    ...
    SuggestSearchResult: ResolversTypes['GenericSuggestSearchResult'] | ResolversTypes['ItemSuggestSearchResult'];
...
export type ResolversParentTypes = {
    ...
    SuggestSearchResult: ResolversParentTypes['GenericSuggestSearchResult'] | ResolversParentTypes['ItemSuggestSearchResult'];
...
export type AcceptedContentTypeResolvers<ContextType = any, ParentType extends ResolversParentTypes['AcceptedContentType'] = ResolversParentTypes['AcceptedContentType']> = {
...
export type AccessTokenMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['AccessTokenMutations'] = ResolversParentTypes['AccessTokenMutations']> = {
...
export type AddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['Address'] = ResolversParentTypes['Address']> = {
    ...
    metaProperty?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<AddressMetaPropertyArgs, 'key'>>;
...
export type ApiCallMetricsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ApiCallMetrics'] = ResolversParentTypes['ApiCallMetrics']> = {
    count?: Resolver<ResolversTypes['Int'], ParentType, ContextType, Partial<ApiCallMetricsCountArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type AppConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['AppConnection'] = ResolversParentTypes['AppConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['AppConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type AppConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['AppConnectionEdge'] = ResolversParentTypes['AppConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['App'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type AppMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['AppMutations'] = ResolversParentTypes['AppMutations']> = {
    create?: Resolver<ResolversTypes['App'], ParentType, ContextType, RequireFields<AppMutationsCreateArgs, 'input'>>;
    delete?: Resolver<ResolversTypes['Int'], ParentType, ContextType, RequireFields<AppMutationsDeleteArgs, 'identifier' | 'tenantId'>>;
    update?: Resolver<ResolversTypes['App'], ParentType, ContextType, RequireFields<AppMutationsUpdateArgs, 'identifier' | 'input' | 'tenantId'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type AppQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['AppQueries'] = ResolversParentTypes['AppQueries']> = {
    get?: Resolver<Maybe<ResolversTypes['App']>, ParentType, ContextType, RequireFields<AppQueriesGetArgs, 'identifier' | 'tenantId'>>;
    getMany?: Resolver<ResolversTypes['AppConnection'], ParentType, ContextType, RequireFields<AppQueriesGetManyArgs, 'filter'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type BandwidthUsageMetricsResolvers<ContextType = any, ParentType extends ResolversParentTypes['BandwidthUsageMetrics'] = ResolversParentTypes['BandwidthUsageMetrics']> = {
    total?: Resolver<ResolversTypes['Float'], ParentType, ContextType, RequireFields<BandwidthUsageMetricsTotalArgs, 'unit'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type BooleanContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['BooleanContent'] = ResolversParentTypes['BooleanContent']> = {
    value?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type BulkTaskTenantCopyInfoResolvers<ContextType = any, ParentType extends ResolversParentTypes['BulkTaskTenantCopyInfo'] = ResolversParentTypes['BulkTaskTenantCopyInfo']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type CashPaymentResolvers<ContextType = any, ParentType extends ResolversParentTypes['CashPayment'] = ResolversParentTypes['CashPayment']> = {
...
export type ComponentChoiceComponentConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['ComponentChoiceComponentConfig'] = ResolversParentTypes['ComponentChoiceComponentConfig']> = {
    choices?: Resolver<Array<ResolversTypes['ShapeComponent']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ComponentChoiceContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ComponentChoiceContent'] = ResolversParentTypes['ComponentChoiceContent']> = {
    selectedComponent?: Resolver<ResolversTypes['Component'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ComponentConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['ComponentConfig'] = ResolversParentTypes['ComponentConfig']> = {
...
export type ComponentContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ComponentContent'] = ResolversParentTypes['ComponentContent']> = {
...
export type ContentChunkComponentConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['ContentChunkComponentConfig'] = ResolversParentTypes['ContentChunkComponentConfig']> = {
...
export type ContentChunkContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ContentChunkContent'] = ResolversParentTypes['ContentChunkContent']> = {
    chunks?: Resolver<Array<Array<ResolversTypes['Component']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type CurrencySummaryResolvers<ContextType = any, ParentType extends ResolversParentTypes['CurrencySummary'] = ResolversParentTypes['CurrencySummary']> = {
    currency?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    value?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type CurrencySummaryReportResolvers<ContextType = any, ParentType extends ResolversParentTypes['CurrencySummaryReport'] = ResolversParentTypes['CurrencySummaryReport']> = {
...
export type CustomPaymentResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomPayment'] = ResolversParentTypes['CustomPayment']> = {
    properties?: Resolver<Maybe<Array<ResolversTypes['CustomProperties']>>, ParentType, ContextType>;
    provider?: Resolver<ResolversTypes['PaymentProvider'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type CustomPropertiesResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomProperties'] = ResolversParentTypes['CustomProperties']> = {
...
export type CustomerConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerConnectionEdge'] = ResolversParentTypes['CustomerConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['Customer'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type CustomerMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerMutations'] = ResolversParentTypes['CustomerMutations']> = {
    ...
    setMetadata?: Resolver<ResolversTypes['Customer'], ParentType, ContextType, RequireFields<CustomerMutationsSetMetadataArgs, 'identifier' | 'key' | 'tenantId' | 'value'>>;
...
export type CustomerQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerQueries'] = ResolversParentTypes['CustomerQueries']> = {
...
export type DatetimeContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['DatetimeContent'] = ResolversParentTypes['DatetimeContent']> = {
    datetime?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type DigitalAssetPreferencesResolvers<ContextType = any, ParentType extends ResolversParentTypes['DigitalAssetPreferences'] = ResolversParentTypes['DigitalAssetPreferences']> = {
...
export type DocumentResolvers<ContextType = any, ParentType extends ResolversParentTypes['Document'] = ResolversParentTypes['Document']> = {
    ...
    hasVersion?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<DocumentHasVersionArgs>>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type DocumentMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['DocumentMutations'] = ResolversParentTypes['DocumentMutations']> = {
...
export type DocumentQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['DocumentQueries'] = ResolversParentTypes['DocumentQueries']> = {
...
export type ExperimentalPreferenceEnabledResolvers<ContextType = any, ParentType extends ResolversParentTypes['ExperimentalPreferenceEnabled'] = ResolversParentTypes['ExperimentalPreferenceEnabled']> = {
    enabled?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ExperimentalPreferencesResolvers<ContextType = any, ParentType extends ResolversParentTypes['ExperimentalPreferences'] = ResolversParentTypes['ExperimentalPreferences']> = {
    componentsOnVariants?: Resolver<Maybe<ResolversTypes['ExperimentalPreferenceEnabled']>, ParentType, ContextType>;
    dam?: Resolver<Maybe<ResolversTypes['DigitalAssetPreferences']>, ParentType, ContextType>;
    get?: Resolver<Maybe<ResolversTypes['Preference']>, ParentType, ContextType, RequireFields<ExperimentalPreferencesGetArgs, 'name'>>;
    nerdyView?: Resolver<Maybe<ResolversTypes['NerdyViewPreferences']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type FileContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['FileContent'] = ResolversParentTypes['FileContent']> = {
    files?: Resolver<Maybe<Array<ResolversTypes['File']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type FileQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['FileQueries'] = ResolversParentTypes['FileQueries']> = {
    get?: Resolver<Maybe<ResolversTypes['File']>, ParentType, ContextType, RequireFields<FileQueriesGetArgs, 'key' | 'language'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type FileSizeResolvers<ContextType = any, ParentType extends ResolversParentTypes['FileSize'] = ResolversParentTypes['FileSize']> = {
    size?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
    unit?: Resolver<ResolversTypes['FileSizeUnit'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type FileUploadMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['FileUploadMutations'] = ResolversParentTypes['FileUploadMutations']> = {
...
export type FilesComponentConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['FilesComponentConfig'] = ResolversParentTypes['FilesComponentConfig']> = {
...
export type FocalPointResolvers<ContextType = any, ParentType extends ResolversParentTypes['FocalPoint'] = ResolversParentTypes['FocalPoint']> = {
...
export type FolderResolvers<ContextType = any, ParentType extends ResolversParentTypes['Folder'] = ResolversParentTypes['Folder']> = {
    ...
    createdAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    externalReference?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    hasVersion?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<FolderHasVersionArgs>>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    language?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    relatingItems?: Resolver<Maybe<Array<ResolversTypes['Item']>>, ParentType, ContextType>;
...
export type FolderMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['FolderMutations'] = ResolversParentTypes['FolderMutations']> = {
...
export type FolderQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['FolderQueries'] = ResolversParentTypes['FolderQueries']> = {
...
export type GenericSuggestSearchResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['GenericSuggestSearchResult'] = ResolversParentTypes['GenericSuggestSearchResult']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type GridResolvers<ContextType = any, ParentType extends ResolversParentTypes['Grid'] = ResolversParentTypes['Grid']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    hasVersion?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, Partial<GridHasVersionArgs>>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    language?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    meta?: Resolver<Maybe<Array<ResolversTypes['KeyValuePair']>>, ParentType, ContextType>;
...
export type GridColumnResolvers<ContextType = any, ParentType extends ResolversParentTypes['GridColumn'] = ResolversParentTypes['GridColumn']> = {
...
export type GridColumnLayoutResolvers<ContextType = any, ParentType extends ResolversParentTypes['GridColumnLayout'] = ResolversParentTypes['GridColumnLayout']> = {
...
export type GridMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['GridMutations'] = ResolversParentTypes['GridMutations']> = {
...
export type GridPublishInfoResolvers<ContextType = any, ParentType extends ResolversParentTypes['GridPublishInfo'] = ResolversParentTypes['GridPublishInfo']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    versionId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type GridQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['GridQueries'] = ResolversParentTypes['GridQueries']> = {
...
export type GridRelationsContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['GridRelationsContent'] = ResolversParentTypes['GridRelationsContent']> = {
    grids?: Resolver<Maybe<Array<ResolversTypes['Grid']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type GridRowResolvers<ContextType = any, ParentType extends ResolversParentTypes['GridRow'] = ResolversParentTypes['GridRow']> = {
...
export type IObjectMetricsResolvers<ContextType = any, ParentType extends ResolversParentTypes['IObjectMetrics'] = ResolversParentTypes['IObjectMetrics']> = {
    __resolveType: TypeResolveFn<'ApiCallMetrics' | 'ItemMetrics' | 'OrderMetrics' | 'ShapeMetrics' | 'WebhookMetrics', ParentType, ContextType>;
    count?: Resolver<ResolversTypes['Int'], ParentType, ContextType, Partial<IObjectMetricsCountArgs>>;
};
export type IObjectReportsResolvers<ContextType = any, ParentType extends ResolversParentTypes['IObjectReports'] = ResolversParentTypes['IObjectReports']> = {
    ...
    total?: Resolver<ResolversTypes['Float'], ParentType, ContextType, Partial<IObjectReportsTotalArgs>>;
};
export type IdentifierSuggestionResolvers<ContextType = any, ParentType extends ResolversParentTypes['IdentifierSuggestion'] = ResolversParentTypes['IdentifierSuggestion']> = {
...
export type ImageResolvers<ContextType = any, ParentType extends ResolversParentTypes['Image'] = ResolversParentTypes['Image']> = {
    ...
    focalPoint?: Resolver<Maybe<ResolversTypes['FocalPoint']>, ParentType, ContextType>;
...
export type ImageConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ImageConnection'] = ResolversParentTypes['ImageConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['ImageConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ImageConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ImageConnectionEdge'] = ResolversParentTypes['ImageConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['Image'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ImageContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ImageContent'] = ResolversParentTypes['ImageContent']> = {
    images?: Resolver<Maybe<Array<ResolversTypes['Image']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ImageMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ImageMutations'] = ResolversParentTypes['ImageMutations']> = {
    delete?: Resolver<ResolversTypes['Int'], ParentType, ContextType, RequireFields<ImageMutationsDeleteArgs, 'key' | 'tenantId'>>;
    registerImage?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType, RequireFields<ImageMutationsRegisterImageArgs, 'key' | 'tenantId'>>;
    ...
    update?: Resolver<ResolversTypes['Image'], ParentType, ContextType, RequireFields<ImageMutationsUpdateArgs, 'input' | 'key' | 'language'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ImageQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['ImageQueries'] = ResolversParentTypes['ImageQueries']> = {
    get?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType, RequireFields<ImageQueriesGetArgs, 'key'>>;
    getItems?: Resolver<Maybe<ResolversTypes['ItemConnection']>, ParentType, ContextType, RequireFields<ImageQueriesGetItemsArgs, 'first' | 'key' | 'language' | 'tenantId' | 'versionLabel'>>;
    getMany?: Resolver<Maybe<ResolversTypes['ImageConnection']>, ParentType, ContextType, RequireFields<ImageQueriesGetManyArgs, 'first' | 'language' | 'sort' | 'sortField' | 'tenantId'>>;
    getTopics?: Resolver<Maybe<ResolversTypes['TopicConnection']>, ParentType, ContextType, RequireFields<ImageQueriesGetTopicsArgs, 'first' | 'key' | 'language' | 'tenantId'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ImageVariantResolvers<ContextType = any, ParentType extends ResolversParentTypes['ImageVariant'] = ResolversParentTypes['ImageVariant']> = {
...
export type InviteTokenResolvers<ContextType = any, ParentType extends ResolversParentTypes['InviteToken'] = ResolversParentTypes['InviteToken']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type InviteTokenMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['InviteTokenMutations'] = ResolversParentTypes['InviteTokenMutations']> = {
...
export type ItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['Item'] = ResolversParentTypes['Item']> = {
    ...
    createdAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    externalReference?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    hasVersion?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<ItemHasVersionArgs>>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    language?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    relatingItems?: Resolver<Maybe<Array<ResolversTypes['Item']>>, ParentType, ContextType>;
...
export type ItemConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ItemConnection'] = ResolversParentTypes['ItemConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['ItemConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type ItemMetricsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ItemMetrics'] = ResolversParentTypes['ItemMetrics']> = {
    count?: Resolver<ResolversTypes['Int'], ParentType, ContextType, Partial<ItemMetricsCountArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ItemMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ItemMutations'] = ResolversParentTypes['ItemMutations']> = {
...
export type ItemQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['ItemQueries'] = ResolversParentTypes['ItemQueries']> = {
...
export type ItemRelationsComponentConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['ItemRelationsComponentConfig'] = ResolversParentTypes['ItemRelationsComponentConfig']> = {
    ...
    quickSelect?: Resolver<Maybe<ResolversTypes['ItemRelationsComponentQuickSelectConfig']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ItemRelationsComponentQuickSelectConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['ItemRelationsComponentQuickSelectConfig'] = ResolversParentTypes['ItemRelationsComponentQuickSelectConfig']> = {
    folders?: Resolver<Maybe<Array<ResolversTypes['ItemRelationsComponentQuickSelectFolderConfig']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ItemRelationsComponentQuickSelectFolderConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['ItemRelationsComponentQuickSelectFolderConfig'] = ResolversParentTypes['ItemRelationsComponentQuickSelectFolderConfig']> = {
    folderId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ItemRelationsContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ItemRelationsContent'] = ResolversParentTypes['ItemRelationsContent']> = {
    items?: Resolver<Maybe<Array<ResolversTypes['Item']>>, ParentType, ContextType>;
    productVariants?: Resolver<Maybe<Array<ResolversTypes['ProductVariant']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ItemSuggestSearchResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['ItemSuggestSearchResult'] = ResolversParentTypes['ItemSuggestSearchResult']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    path?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type KlarnaPaymentResolvers<ContextType = any, ParentType extends ResolversParentTypes['KlarnaPayment'] = ResolversParentTypes['KlarnaPayment']> = {
    id?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type LanguageMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['LanguageMutations'] = ResolversParentTypes['LanguageMutations']> = {
...
export type LocationContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['LocationContent'] = ResolversParentTypes['LocationContent']> = {
...
export type MarketResolvers<ContextType = any, ParentType extends ResolversParentTypes['Market'] = ResolversParentTypes['Market']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    customerIdentifiers?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    tenant?: Resolver<ResolversTypes['Tenant'], ParentType, ContextType>;
    tenantId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type MarketConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['MarketConnection'] = ResolversParentTypes['MarketConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['MarketConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type MarketConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['MarketConnectionEdge'] = ResolversParentTypes['MarketConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['Market'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type MarketMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['MarketMutations'] = ResolversParentTypes['MarketMutations']> = {
    create?: Resolver<ResolversTypes['Market'], ParentType, ContextType, RequireFields<MarketMutationsCreateArgs, 'input'>>;
    delete?: Resolver<ResolversTypes['Int'], ParentType, ContextType, RequireFields<MarketMutationsDeleteArgs, 'identifier' | 'tenantId'>>;
    update?: Resolver<ResolversTypes['Market'], ParentType, ContextType, RequireFields<MarketMutationsUpdateArgs, 'identifier' | 'input' | 'tenantId'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type MarketQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['MarketQueries'] = ResolversParentTypes['MarketQueries']> = {
    get?: Resolver<Maybe<ResolversTypes['Market']>, ParentType, ContextType, RequireFields<MarketQueriesGetArgs, 'identifier' | 'tenantId'>>;
    getMany?: Resolver<ResolversTypes['MarketConnection'], ParentType, ContextType, RequireFields<MarketQueriesGetManyArgs, 'first' | 'tenantId'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type MeMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['MeMutations'] = ResolversParentTypes['MeMutations']> = {
    ...
    setPreference?: Resolver<Maybe<ResolversTypes['Preference']>, ParentType, ContextType, RequireFields<MeMutationsSetPreferenceArgs, 'input'>>;
    setPreferences?: Resolver<Maybe<ResolversTypes['Preferences']>, ParentType, ContextType, RequireFields<MeMutationsSetPreferencesArgs, 'input'>>;
    update?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<MeMutationsUpdateArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
    ...
    priceList?: Resolver<ResolversTypes['PriceListMutations'], ParentType, ContextType>;
...
export type NerdyViewPreferencesResolvers<ContextType = any, ParentType extends ResolversParentTypes['NerdyViewPreferences'] = ResolversParentTypes['NerdyViewPreferences']> = {
    enabled?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type NumericComponentConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['NumericComponentConfig'] = ResolversParentTypes['NumericComponentConfig']> = {
...
export type NumericContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['NumericContent'] = ResolversParentTypes['NumericContent']> = {
...
export type OrderConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderConnectionEdge'] = ResolversParentTypes['OrderConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type OrderItemMeteredVariableResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderItemMeteredVariable'] = ResolversParentTypes['OrderItemMeteredVariable']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    price?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
    usage?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type OrderItemSubscriptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderItemSubscription'] = ResolversParentTypes['OrderItemSubscription']> = {
...
export type OrderMetricsResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderMetrics'] = ResolversParentTypes['OrderMetrics']> = {
    count?: Resolver<ResolversTypes['Int'], ParentType, ContextType, Partial<OrderMetricsCountArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type OrderMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderMutations'] = ResolversParentTypes['OrderMutations']> = {
...
export type OrderPipelineResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderPipeline'] = ResolversParentTypes['OrderPipeline']> = {
...
export type OrderQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderQueries'] = ResolversParentTypes['OrderQueries']> = {
...
export type OrdersReportResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrdersReport'] = ResolversParentTypes['OrdersReport']> = {
    ...
    total?: Resolver<ResolversTypes['Int'], ParentType, ContextType, Partial<OrdersReportTotalArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type ParagraphCollectionContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ParagraphCollectionContent'] = ResolversParentTypes['ParagraphCollectionContent']> = {
    paragraphs?: Resolver<Maybe<Array<ResolversTypes['ParagraphContent']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ParagraphContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ParagraphContent'] = ResolversParentTypes['ParagraphContent']> = {
...
export type PaypalPaymentResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaypalPayment'] = ResolversParentTypes['PaypalPayment']> = {
    id?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PipelineConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['PipelineConnection'] = ResolversParentTypes['PipelineConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['PipelineConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PipelineConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['PipelineConnectionEdge'] = ResolversParentTypes['PipelineConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['Pipeline'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PipelineMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PipelineMutations'] = ResolversParentTypes['PipelineMutations']> = {
...
export type PipelineQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['PipelineQueries'] = ResolversParentTypes['PipelineQueries']> = {
...
export type PipelineStageResolvers<ContextType = any, ParentType extends ResolversParentTypes['PipelineStage'] = ResolversParentTypes['PipelineStage']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type PreferencesResolvers<ContextType = any, ParentType extends ResolversParentTypes['Preferences'] = ResolversParentTypes['Preferences']> = {
    experimental?: Resolver<Maybe<ResolversTypes['ExperimentalPreferences']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PresignedUploadRequestResolvers<ContextType = any, ParentType extends ResolversParentTypes['PresignedUploadRequest'] = ResolversParentTypes['PresignedUploadRequest']> = {
...
export type PriceListResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceList'] = ResolversParentTypes['PriceList']> = {
    ...
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    modifierType?: Resolver<ResolversTypes['PriceListModifierType'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    price?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType, RequireFields<PriceListPriceArgs, 'identifier'>>;
    priceVariants?: Resolver<Maybe<Array<ResolversTypes['PriceListPriceVariant']>>, ParentType, ContextType>;
    selectedProductVariants?: Resolver<ResolversTypes['PriceListSelectedProductVariants'], ParentType, ContextType>;
    startDate?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    targetAudience?: Resolver<ResolversTypes['PriceListTargetAudience'], ParentType, ContextType>;
    tenant?: Resolver<ResolversTypes['Tenant'], ParentType, ContextType>;
    tenantId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    updatedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PriceListConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceListConnection'] = ResolversParentTypes['PriceListConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['PriceListConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PriceListConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceListConnectionEdge'] = ResolversParentTypes['PriceListConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['PriceList'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PriceListMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceListMutations'] = ResolversParentTypes['PriceListMutations']> = {
    create?: Resolver<ResolversTypes['PriceList'], ParentType, ContextType, RequireFields<PriceListMutationsCreateArgs, 'input'>>;
    delete?: Resolver<ResolversTypes['Int'], ParentType, ContextType, RequireFields<PriceListMutationsDeleteArgs, 'identifier' | 'tenantId'>>;
    removeSelectedProductVariants?: Resolver<ResolversTypes['PriceList'], ParentType, ContextType, RequireFields<PriceListMutationsRemoveSelectedProductVariantsArgs, 'identifier' | 'tenantId' | 'variants'>>;
    update?: Resolver<ResolversTypes['PriceList'], ParentType, ContextType, RequireFields<PriceListMutationsUpdateArgs, 'identifier' | 'input' | 'tenantId'>>;
    upsertSelectedProductVariants?: Resolver<ResolversTypes['PriceList'], ParentType, ContextType, RequireFields<PriceListMutationsUpsertSelectedProductVariantsArgs, 'identifier' | 'tenantId' | 'variants'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PriceListPriceVariantResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceListPriceVariant'] = ResolversParentTypes['PriceListPriceVariant']> = {
    decimalPlaces?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    modifier?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PriceListProductResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceListProduct'] = ResolversParentTypes['PriceListProduct']> = {
    priceVariants?: Resolver<Maybe<Array<ResolversTypes['PriceListPriceVariant']>>, ParentType, ContextType>;
    sku?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PriceListQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceListQueries'] = ResolversParentTypes['PriceListQueries']> = {
    get?: Resolver<Maybe<ResolversTypes['PriceList']>, ParentType, ContextType, RequireFields<PriceListQueriesGetArgs, 'identifier' | 'tenantId'>>;
    getMany?: Resolver<Maybe<ResolversTypes['PriceListConnection']>, ParentType, ContextType, RequireFields<PriceListQueriesGetManyArgs, 'first' | 'tenantId'>>;
    getProductVariants?: Resolver<Maybe<ResolversTypes['ProductVariantConnection']>, ParentType, ContextType, RequireFields<PriceListQueriesGetProductVariantsArgs, 'first' | 'identifier' | 'language' | 'tenantId' | 'versionLabel'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PriceListSelectedProductVariantsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceListSelectedProductVariants'] = ResolversParentTypes['PriceListSelectedProductVariants']> = {
    type?: Resolver<Maybe<ResolversTypes['PriceListProductSelectionType']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PriceListTargetAudienceResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceListTargetAudience'] = ResolversParentTypes['PriceListTargetAudience']> = {
    marketIdentifiers?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
    type?: Resolver<ResolversTypes['PriceListTargetAudienceType'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PriceVariantResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceVariant'] = ResolversParentTypes['PriceVariant']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    currency?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PriceVariantMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceVariantMutations'] = ResolversParentTypes['PriceVariantMutations']> = {
...
export type PriceVariantQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['PriceVariantQueries'] = ResolversParentTypes['PriceVariantQueries']> = {
...
export type ProductResolvers<ContextType = any, ParentType extends ResolversParentTypes['Product'] = ResolversParentTypes['Product']> = {
    ...
    externalReference?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    hasVersion?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<ProductHasVersionArgs>>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    isSubscriptionOnly?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
    ...
    type?: Resolver<ResolversTypes['ItemType'], ParentType, ContextType>;
    updatedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    variant?: Resolver<Maybe<ResolversTypes['ProductVariant']>, ParentType, ContextType, RequireFields<ProductVariantArgs, 'sku'>>;
...
export type ProductMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductMutations'] = ResolversParentTypes['ProductMutations']> = {
    addVariant?: Resolver<ResolversTypes['Product'], ParentType, ContextType, RequireFields<ProductMutationsAddVariantArgs, 'input' | 'language' | 'productId'>>;
    ...
    setDefaultVariant?: Resolver<ResolversTypes['Product'], ParentType, ContextType, RequireFields<ProductMutationsSetDefaultVariantArgs, 'language' | 'productId'>>;
    ...
    updateVariant?: Resolver<ResolversTypes['Product'], ParentType, ContextType, RequireFields<ProductMutationsUpdateVariantArgs, 'input' | 'language' | 'productId'>>;
    updateVariantComponent?: Resolver<ResolversTypes['Product'], ParentType, ContextType, RequireFields<ProductMutationsUpdateVariantComponentArgs, 'input' | 'language' | 'productId' | 'sku'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ProductPriceVariantResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductPriceVariant'] = ResolversParentTypes['ProductPriceVariant']> = {
    currency?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    price?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
    priceList?: Resolver<Maybe<ResolversTypes['ProductVariantPriceList']>, ParentType, ContextType, RequireFields<ProductPriceVariantPriceListArgs, 'identifier'>>;
    priceLists?: Resolver<Maybe<Array<ResolversTypes['ProductVariantPriceList']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ProductQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductQueries'] = ResolversParentTypes['ProductQueries']> = {
    ...
    getVariants?: Resolver<Maybe<Array<ResolversTypes['ProductVariant']>>, ParentType, ContextType, RequireFields<ProductQueriesGetVariantsArgs, 'language' | 'tenantId' | 'versionLabel'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ProductStockLocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductStockLocation'] = ResolversParentTypes['ProductStockLocation']> = {
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    meta?: Resolver<Maybe<Array<ResolversTypes['KeyValuePair']>>, ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ProductSubscriptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscription'] = ResolversParentTypes['ProductSubscription']> = {
    customer?: Resolver<Maybe<ResolversTypes['Customer']>, ParentType, ContextType>;
...
export type ProductSubscriptionConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionConnection'] = ResolversParentTypes['ProductSubscriptionConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['ProductSubscriptionConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ProductSubscriptionConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionConnectionEdge'] = ResolversParentTypes['ProductSubscriptionConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['ProductSubscription'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ProductSubscriptionHistoryEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionHistoryEvent'] = ResolversParentTypes['ProductSubscriptionHistoryEvent']> = {
...
export type ProductSubscriptionHistoryEventCancellationResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionHistoryEventCancellation'] = ResolversParentTypes['ProductSubscriptionHistoryEventCancellation']> = {
...
export type ProductSubscriptionHistoryEventRenewalResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionHistoryEventRenewal'] = ResolversParentTypes['ProductSubscriptionHistoryEventRenewal']> = {
    activeUntil?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    currency?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    price?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type ProductSubscriptionHistoryEventRenewalDueBroadcastResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionHistoryEventRenewalDueBroadcast'] = ResolversParentTypes['ProductSubscriptionHistoryEventRenewalDueBroadcast']> = {
...
export type ProductSubscriptionItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionItem'] = ResolversParentTypes['ProductSubscriptionItem']> = {
    imageUrl?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    meta?: Resolver<Maybe<Array<ResolversTypes['KeyValuePair']>>, ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    quantity?: Resolver<ResolversTypes['NonNegativeInt'], ParentType, ContextType>;
...
export type ProductSubscriptionMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionMutations'] = ResolversParentTypes['ProductSubscriptionMutations']> = {
...
export type ProductSubscriptionPhaseResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionPhase'] = ResolversParentTypes['ProductSubscriptionPhase']> = {
    currency?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ProductSubscriptionQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionQueries'] = ResolversParentTypes['ProductSubscriptionQueries']> = {
...
export type ProductSubscriptionStatusResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionStatus'] = ResolversParentTypes['ProductSubscriptionStatus']> = {
    activeUntil?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    currency?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    price?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type ProductSubscriptionUsageResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSubscriptionUsage'] = ResolversParentTypes['ProductSubscriptionUsage']> = {
...
export type ProductVariantConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantConnection'] = ResolversParentTypes['ProductVariantConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['ProductVariantConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ProductVariantConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantConnectionEdge'] = ResolversParentTypes['ProductVariantConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['ProductVariant'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ProductVariantPriceListResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantPriceList'] = ResolversParentTypes['ProductVariantPriceList']> = {
    endDate?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    modifier?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
    modifierType?: Resolver<ResolversTypes['PriceListModifierType'], ParentType, ContextType>;
...
export type ProductVariantSubscriptionMeteredVariableResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantSubscriptionMeteredVariable'] = ResolversParentTypes['ProductVariantSubscriptionMeteredVariable']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ProductVariantSubscriptionPlanResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantSubscriptionPlan'] = ResolversParentTypes['ProductVariantSubscriptionPlan']> = {
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type ProductVariantSubscriptionPlanPeriodResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantSubscriptionPlanPeriod'] = ResolversParentTypes['ProductVariantSubscriptionPlanPeriod']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type ProductVariantSubscriptionPlanPricingResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantSubscriptionPlanPricing'] = ResolversParentTypes['ProductVariantSubscriptionPlanPricing']> = {
...
export type ProductVariantSubscriptionPlanTierResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantSubscriptionPlanTier'] = ResolversParentTypes['ProductVariantSubscriptionPlanTier']> = {
...
export type PropertiesTableComponentConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['PropertiesTableComponentConfig'] = ResolversParentTypes['PropertiesTableComponentConfig']> = {
    sections?: Resolver<Array<ResolversTypes['PropertiesTableComponentConfigSection']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PropertiesTableComponentConfigSectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['PropertiesTableComponentConfigSection'] = ResolversParentTypes['PropertiesTableComponentConfigSection']> = {
    keys?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
    title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PropertiesTableComponentSectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['PropertiesTableComponentSection'] = ResolversParentTypes['PropertiesTableComponentSection']> = {
    properties?: Resolver<Maybe<Array<ResolversTypes['KeyValuePair']>>, ParentType, ContextType>;
    title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PropertiesTableContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['PropertiesTableContent'] = ResolversParentTypes['PropertiesTableContent']> = {
    sections?: Resolver<Maybe<Array<ResolversTypes['PropertiesTableComponentSection']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type PublishInfoResolvers<ContextType = any, ParentType extends ResolversParentTypes['PublishInfo'] = ResolversParentTypes['PublishInfo']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
    ...
    priceList?: Resolver<ResolversTypes['PriceListQueries'], ParentType, ContextType>;
...
export type ReportMetricResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReportMetric'] = ResolversParentTypes['ReportMetric']> = {
    currency?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type RichTextContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['RichTextContent'] = ResolversParentTypes['RichTextContent']> = {
...
export type SalesReportResolvers<ContextType = any, ParentType extends ResolversParentTypes['SalesReport'] = ResolversParentTypes['SalesReport']> = {
    ...
    total?: Resolver<ResolversTypes['Float'], ParentType, ContextType, Partial<SalesReportTotalArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SearchQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['SearchQueries'] = ResolversParentTypes['SearchQueries']> = {
...
export type SelectionComponentConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['SelectionComponentConfig'] = ResolversParentTypes['SelectionComponentConfig']> = {
    max?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
    min?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
    options?: Resolver<Array<ResolversTypes['SelectionComponentOptionConfig']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SelectionComponentOptionConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['SelectionComponentOptionConfig'] = ResolversParentTypes['SelectionComponentOptionConfig']> = {
    isPreselected?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
    key?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    value?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SelectionContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['SelectionContent'] = ResolversParentTypes['SelectionContent']> = {
...
export type ShapeResolvers<ContextType = any, ParentType extends ResolversParentTypes['Shape'] = ResolversParentTypes['Shape']> = {
    ...
    updatedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    variantComponents?: Resolver<Maybe<Array<ResolversTypes['ShapeComponent']>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ShapeComponentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShapeComponent'] = ResolversParentTypes['ShapeComponent']> = {
...
export type ShapeMetricsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShapeMetrics'] = ResolversParentTypes['ShapeMetrics']> = {
    count?: Resolver<ResolversTypes['Int'], ParentType, ContextType, Partial<ShapeMetricsCountArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type ShapeMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShapeMutations'] = ResolversParentTypes['ShapeMutations']> = {
    create?: Resolver<ResolversTypes['Shape'], ParentType, ContextType, RequireFields<ShapeMutationsCreateArgs, 'input'>>;
    delete?: Resolver<ResolversTypes['Int'], ParentType, ContextType, Partial<ShapeMutationsDeleteArgs>>;
...
export type ShapeQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShapeQueries'] = ResolversParentTypes['ShapeQueries']> = {
    get?: Resolver<Maybe<ResolversTypes['Shape']>, ParentType, ContextType, Partial<ShapeQueriesGetArgs>>;
    getMany?: Resolver<Maybe<Array<ResolversTypes['Shape']>>, ParentType, ContextType, RequireFields<ShapeQueriesGetManyArgs, 'tenantId'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SingleLineContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['SingleLineContent'] = ResolversParentTypes['SingleLineContent']> = {
    text?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type StockLocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['StockLocation'] = ResolversParentTypes['StockLocation']> = {
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    settings?: Resolver<ResolversTypes['StockLocationSettings'], ParentType, ContextType>;
    tenant?: Resolver<ResolversTypes['Tenant'], ParentType, ContextType>;
    tenantId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type StockLocationMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['StockLocationMutations'] = ResolversParentTypes['StockLocationMutations']> = {
...
export type StockLocationQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['StockLocationQueries'] = ResolversParentTypes['StockLocationQueries']> = {
...
export type StockLocationSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['StockLocationSettings'] = ResolversParentTypes['StockLocationSettings']> = {
...
export type StripePaymentResolvers<ContextType = any, ParentType extends ResolversParentTypes['StripePayment'] = ResolversParentTypes['StripePayment']> = {
...
export type SubscriptionContractResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContract'] = ResolversParentTypes['SubscriptionContract']> = {
...
export type SubscriptionContractAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractAddress'] = ResolversParentTypes['SubscriptionContractAddress']> = {
    city?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    country?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    email?: Resolver<Maybe<ResolversTypes['EmailAddress']>, ParentType, ContextType>;
    firstName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SubscriptionContractCancelledEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractCancelledEvent'] = ResolversParentTypes['SubscriptionContractCancelledEvent']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    type?: Resolver<ResolversTypes['SubscriptionContractEventType'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SubscriptionContractConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractConnection'] = ResolversParentTypes['SubscriptionContractConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['SubscriptionContractConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SubscriptionContractConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractConnectionEdge'] = ResolversParentTypes['SubscriptionContractConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['SubscriptionContract'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SubscriptionContractEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractEvent'] = ResolversParentTypes['SubscriptionContractEvent']> = {
...
export type SubscriptionContractEventConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractEventConnection'] = ResolversParentTypes['SubscriptionContractEventConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['SubscriptionContractEventConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SubscriptionContractEventConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractEventConnectionEdge'] = ResolversParentTypes['SubscriptionContractEventConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['SubscriptionContractEvent'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SubscriptionContractEventQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractEventQueries'] = ResolversParentTypes['SubscriptionContractEventQueries']> = {
...
export type SubscriptionContractItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractItem'] = ResolversParentTypes['SubscriptionContractItem']> = {
    imageUrl?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    meta?: Resolver<Maybe<Array<ResolversTypes['KeyValuePair']>>, ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    sku?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type SubscriptionContractMeteredVariableReferenceResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractMeteredVariableReference'] = ResolversParentTypes['SubscriptionContractMeteredVariableReference']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type SubscriptionContractMeteredVariableTierReferenceResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractMeteredVariableTierReference'] = ResolversParentTypes['SubscriptionContractMeteredVariableTierReference']> = {
    currency?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    price?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
    threshold?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SubscriptionContractMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractMutations'] = ResolversParentTypes['SubscriptionContractMutations']> = {
...
export type SubscriptionContractPhaseResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractPhase'] = ResolversParentTypes['SubscriptionContractPhase']> = {
    currency?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type SubscriptionContractQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractQueries'] = ResolversParentTypes['SubscriptionContractQueries']> = {
...
export type SubscriptionContractRenewalDueBroadcastEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractRenewalDueBroadcastEvent'] = ResolversParentTypes['SubscriptionContractRenewalDueBroadcastEvent']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type SubscriptionContractRenewalDueBroadcastEventDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractRenewalDueBroadcastEventData'] = ResolversParentTypes['SubscriptionContractRenewalDueBroadcastEventData']> = {
    broadcastAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    renewAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SubscriptionContractRenewedEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractRenewedEvent'] = ResolversParentTypes['SubscriptionContractRenewedEvent']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    type?: Resolver<ResolversTypes['SubscriptionContractEventType'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SubscriptionContractStatusResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractStatus'] = ResolversParentTypes['SubscriptionContractStatus']> = {
    activeUntil?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    currency?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    price?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
    renewAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
...
export type SubscriptionContractUsageResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractUsage'] = ResolversParentTypes['SubscriptionContractUsage']> = {
    meteredVariableId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    quantity?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SubscriptionContractUsageTrackedDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractUsageTrackedData'] = ResolversParentTypes['SubscriptionContractUsageTrackedData']> = {
    description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SubscriptionContractUsageTrackedEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractUsageTrackedEvent'] = ResolversParentTypes['SubscriptionContractUsageTrackedEvent']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    data?: Resolver<Maybe<ResolversTypes['SubscriptionContractUsageTrackedData']>, ParentType, ContextType>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    type?: Resolver<ResolversTypes['SubscriptionContractEventType'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type SubscriptionPlanMeteredVariableResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionPlanMeteredVariable'] = ResolversParentTypes['SubscriptionPlanMeteredVariable']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SubscriptionPlanMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionPlanMutations'] = ResolversParentTypes['SubscriptionPlanMutations']> = {
...
export type SubscriptionPlanPeriodResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionPlanPeriod'] = ResolversParentTypes['SubscriptionPlanPeriod']> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type SubscriptionPlanPhaseResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionPlanPhase'] = ResolversParentTypes['SubscriptionPlanPhase']> = {
    period?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    unit?: Resolver<ResolversTypes['SubscriptionPeriodUnit'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SubscriptionPlanQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionPlanQueries'] = ResolversParentTypes['SubscriptionPlanQueries']> = {
...
export type SuggestSearchAggregationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['SuggestSearchAggregations'] = ResolversParentTypes['SuggestSearchAggregations']> = {
...
export type SuggestSearchConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SuggestSearchConnection'] = ResolversParentTypes['SuggestSearchConnection']> = {
...
export type SuggestSearchConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['SuggestSearchConnectionEdge'] = ResolversParentTypes['SuggestSearchConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['SuggestSearchResult'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SuggestSearchResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['SuggestSearchResult'] = ResolversParentTypes['SuggestSearchResult']> = {
    __resolveType: TypeResolveFn<'GenericSuggestSearchResult' | 'ItemSuggestSearchResult', ParentType, ContextType>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    path?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    tenantId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type SuggestSearchTypesAggregationResolvers<ContextType = any, ParentType extends ResolversParentTypes['SuggestSearchTypesAggregation'] = ResolversParentTypes['SuggestSearchTypesAggregation']> = {
...
export type TenantResolvers<ContextType = any, ParentType extends ResolversParentTypes['Tenant'] = ResolversParentTypes['Tenant']> = {
    ...
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    preferences?: Resolver<Maybe<ResolversTypes['TenantPreferences']>, ParentType, ContextType>;
    ...
    tree?: Resolver<Maybe<Array<ResolversTypes['TreeNode']>>, ParentType, ContextType, Partial<TenantTreeArgs>>;
    updatedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
    ...
    webhooks?: Resolver<Maybe<Array<ResolversTypes['Webhook']>>, ParentType, ContextType, Partial<TenantWebhooksArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TenantAuthenticationMethodResolvers<ContextType = any, ParentType extends ResolversParentTypes['TenantAuthenticationMethod'] = ResolversParentTypes['TenantAuthenticationMethod']> = {
...
export type TenantDefaultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['TenantDefaults'] = ResolversParentTypes['TenantDefaults']> = {
    currency?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    language?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TenantFrontendResolvers<ContextType = any, ParentType extends ResolversParentTypes['TenantFrontend'] = ResolversParentTypes['TenantFrontend']> = {
    authentication?: Resolver<Maybe<ResolversTypes['TenantFrontendAuthentication']>, ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    responsive?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
    url?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TenantFrontendAuthenticationResolvers<ContextType = any, ParentType extends ResolversParentTypes['TenantFrontendAuthentication'] = ResolversParentTypes['TenantFrontendAuthentication']> = {
    key?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    value?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TenantMetricsResolvers<ContextType = any, ParentType extends ResolversParentTypes['TenantMetrics'] = ResolversParentTypes['TenantMetrics']> = {
...
export type TenantMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['TenantMutations'] = ResolversParentTypes['TenantMutations']> = {
    ...
    createCopyTask?: Resolver<ResolversTypes['BulkTaskTenantCopyInfo'], ParentType, ContextType, RequireFields<TenantMutationsCreateCopyTaskArgs, 'desiredIdentifier' | 'overwrite' | 'tenantId'>>;
    delete?: Resolver<ResolversTypes['Int'], ParentType, ContextType, RequireFields<TenantMutationsDeleteArgs, 'id'>>;
    regenerateSecrets?: Resolver<ResolversTypes['Tenant'], ParentType, ContextType, RequireFields<TenantMutationsRegenerateSecretsArgs, 'tenantId'>>;
    ...
    setPreferences?: Resolver<ResolversTypes['TenantPreferences'], ParentType, ContextType, RequireFields<TenantMutationsSetPreferencesArgs, 'input' | 'tenantId'>>;
    update?: Resolver<ResolversTypes['Tenant'], ParentType, ContextType, RequireFields<TenantMutationsUpdateArgs, 'id' | 'input'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TenantPreferencesResolvers<ContextType = any, ParentType extends ResolversParentTypes['TenantPreferences'] = ResolversParentTypes['TenantPreferences']> = {
    frontends?: Resolver<Maybe<Array<Maybe<ResolversTypes['TenantFrontend']>>>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TenantQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['TenantQueries'] = ResolversParentTypes['TenantQueries']> = {
    get?: Resolver<Maybe<ResolversTypes['Tenant']>, ParentType, ContextType, Partial<TenantQueriesGetArgs>>;
    getMany?: Resolver<Maybe<Array<ResolversTypes['Tenant']>>, ParentType, ContextType, Partial<TenantQueriesGetManyArgs>>;
...
export type TenantReportsResolvers<ContextType = any, ParentType extends ResolversParentTypes['TenantReports'] = ResolversParentTypes['TenantReports']> = {
...
export type TopicConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicConnection'] = ResolversParentTypes['TopicConnection']> = {
    edges?: Resolver<Maybe<Array<ResolversTypes['TopicConnectionEdge']>>, ParentType, ContextType>;
    pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TopicConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicConnectionEdge'] = ResolversParentTypes['TopicConnectionEdge']> = {
    cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    node?: Resolver<ResolversTypes['Topic'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TopicImagesModifiedResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicImagesModified'] = ResolversParentTypes['TopicImagesModified']> = {
    modified?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TopicItemsModifiedResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicItemsModified'] = ResolversParentTypes['TopicItemsModified']> = {
    modified?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TopicMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicMutations'] = ResolversParentTypes['TopicMutations']> = {
    addImages?: Resolver<ResolversTypes['TopicImagesModified'], ParentType, ContextType, RequireFields<TopicMutationsAddImagesArgs, 'imageKeys' | 'topicId'>>;
    ...
    removeImages?: Resolver<ResolversTypes['TopicImagesModified'], ParentType, ContextType, RequireFields<TopicMutationsRemoveImagesArgs, 'imageKeys' | 'topicId'>>;
...
export type TopicQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicQueries'] = ResolversParentTypes['TopicQueries']> = {
...
export type TopicSearchAggregationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicSearchAggregations'] = ResolversParentTypes['TopicSearchAggregations']> = {
    totalResults?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TopicSearchConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicSearchConnection'] = ResolversParentTypes['TopicSearchConnection']> = {
...
export type TopicSearchConnectionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicSearchConnectionEdge'] = ResolversParentTypes['TopicSearchConnectionEdge']> = {
    node?: Resolver<ResolversTypes['TopicSearchResult'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TopicSearchResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['TopicSearchResult'] = ResolversParentTypes['TopicSearchResult']> = {
...
export type TreeMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['TreeMutations'] = ResolversParentTypes['TreeMutations']> = {
...
export type TreeNodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['TreeNode'] = ResolversParentTypes['TreeNode']> = {
    ...
    item?: Resolver<Maybe<ResolversTypes['Item']>, ParentType, ContextType, Partial<TreeNodeItemArgs>>;
    ...
    parentId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
    path?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, Partial<TreeNodePathArgs>>;
...
export type TreeNodeIdentifierResolvers<ContextType = any, ParentType extends ResolversParentTypes['TreeNodeIdentifier'] = ResolversParentTypes['TreeNodeIdentifier']> = {
    identifier?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    language?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type TreeQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['TreeQueries'] = ResolversParentTypes['TreeQueries']> = {
...
export type UserResolvers<ContextType = any, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = {
    ...
    preferences?: Resolver<Maybe<ResolversTypes['Preferences']>, ParentType, ContextType, Partial<UserPreferencesArgs>>;
...
export type UserMetricsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserMetrics'] = ResolversParentTypes['UserMetrics']> = {
    count?: Resolver<ResolversTypes['Int'], ParentType, ContextType, Partial<UserMetricsCountArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type UserQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserQueries'] = ResolversParentTypes['UserQueries']> = {
    dev_search?: Resolver<Maybe<Array<ResolversTypes['User']>>, ParentType, ContextType, Partial<UserQueriesDev_SearchArgs>>;
...
export type UserTenantRoleResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserTenantRole'] = ResolversParentTypes['UserTenantRole']> = {
...
export type VatTypeResolvers<ContextType = any, ParentType extends ResolversParentTypes['VatType'] = ResolversParentTypes['VatType']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type VatTypeMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['VatTypeMutations'] = ResolversParentTypes['VatTypeMutations']> = {
...
export type VersionInfoResolvers<ContextType = any, ParentType extends ResolversParentTypes['VersionInfo'] = ResolversParentTypes['VersionInfo']> = {
...
export type VersionedRecordInfoResolvers<ContextType = any, ParentType extends ResolversParentTypes['VersionedRecordInfo'] = ResolversParentTypes['VersionedRecordInfo']> = {
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    id?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
    label?: Resolver<ResolversTypes['VersionLabel'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type VersionedServicesResolvers<ContextType = any, ParentType extends ResolversParentTypes['VersionedServices'] = ResolversParentTypes['VersionedServices']> = {
...
export type VideoMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['VideoMutations'] = ResolversParentTypes['VideoMutations']> = {
...
export type WebhookHeaderResolvers<ContextType = any, ParentType extends ResolversParentTypes['WebhookHeader'] = ResolversParentTypes['WebhookHeader']> = {
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    value?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type WebhookInvocationResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['WebhookInvocationResponse'] = ResolversParentTypes['WebhookInvocationResponse']> = {
    body?: Resolver<Maybe<ResolversTypes['JSON']>, ParentType, ContextType>;
    status?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type WebhookMetricsResolvers<ContextType = any, ParentType extends ResolversParentTypes['WebhookMetrics'] = ResolversParentTypes['WebhookMetrics']> = {
    count?: Resolver<ResolversTypes['Int'], ParentType, ContextType, Partial<WebhookMetricsCountArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type WebhookMutationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['WebhookMutations'] = ResolversParentTypes['WebhookMutations']> = {
...
export type WebhookQueriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['WebhookQueries'] = ResolversParentTypes['WebhookQueries']> = {
