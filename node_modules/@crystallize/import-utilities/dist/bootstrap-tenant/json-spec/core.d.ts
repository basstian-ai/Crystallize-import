import { ComponentChoiceComponentConfig, ContentChunkComponentConfig, FileComponentConfig, ItemRelationsComponentConfig, NumericComponentConfig, PropertiesTableComponentConfig, SelectionComponentConfig, Shape, ShapeComponent, ShapeComponentConfig } from '@crystallize/schema';
...
export type JSONComponentContent = JSONSingleLineTranslated | JSONRichTextTranslated | JSONParagraphCollection[] | JSONImages | JSONVideos | JSONFiles | JSONBoolean | JSONDateTime | JSONLocation | JSONPropertiesTable | JSONItemRelations | JSONGridRelations | JSONSelection | JSONContentChunk | JSONNumeric | null;
...
export type JSONShapeComponentComponentChoiceConfig = ComponentChoiceComponentConfig;
...
export type JSONShapeComponentPropertiesTableConfig = PropertiesTableComponentConfig;
