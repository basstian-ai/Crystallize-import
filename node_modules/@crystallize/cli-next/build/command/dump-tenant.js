        ...
        React.createElement(Box, { flexDirection: "column", padding: 1 },
            React.createElement(Box, { flexDirection: "column", marginBottom: 1 },
                React.createElement(Text, null,
                    "Let's dump the tenant ",
                    React.createElement(Text, { color: colors.highlight }, tenantIdentifier),
                    React.createElement(Newline, null)),
                React.createElement(DumpTenantJourney, { folder: folder, multiLingual: multiLingual, tenantIdentifier: tenantIdentifier, isVerbose: isVerbose, excludeOrders: excludeOrders, excludeCustomers: excludeCustomers })))));
    await waitUntilExit();
    return 0;
};
